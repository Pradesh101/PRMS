...
public class Appointment extends javax.swing.JInternalFrame {
    ...
    public Appointment() {
        initComponents();
        Object columns[] = {"Id", "Doctor Name","Patient Name", "Register-Date", "Time", "Status"};
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        String sql = "update appointment set doctorName=?, patientName=?, appointmentDate=?, time=?, status=? where id=?";
        try {
    ...
    private void jButton_ShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ShowActionPerformed
        ...
        if(amf !=null || rmf!= null){
            String sql = "select id,doctorName,patientName,appointmentDate,time,status from appointment";
        try {
            ps = con.prepareStatement(sql);
            //ps.setInt(1,id);
            rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                columnData[3] = rs.getString("appointmentDate");
        ...
        String sql = "select id,doctorName,patientName,appointmentDate,time,status from appointment where d_id = ?";
        try {
            ps = con.prepareStatement(sql);
            ps.setInt(1,id);
            rs = ps.executeQuery();
    ...
    private void jTable_AppMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_AppMouseClicked
        ...
        try {
            ...
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse((String) jTable_App.getValueAt(row, 3));
            jDateChooser.setDate(date);
        } catch (Exception e) {
            System.out.println(e);
        }
        jTextField_Time.setText(jTable_App.getValueAt(row, 4).toString());
        String status = jTable_App.getValueAt(row, 5).toString();
        if (status.equals("On")) {
    ...
    private void jButton_PresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_PresActionPerformed
        ...
        if(row == -1){
         ...
         String sql="select p_id from appointment where id= ?";
         try{
            ps = con.prepareStatement(sql);
            ps.setString(1,id);
            rs = ps.executeQuery();
